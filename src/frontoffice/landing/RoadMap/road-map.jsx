              ...
              <div className="hori-timeline">
                ...
                >
                  <SwiperSlide className="item event-list">
                    <div>
                      <div className="event-date">
                        <div className="mb-1 text-primary">December, 2019</div>
                  ...
                  <SwiperSlide className="item event-list active">
                    <div>
                      <div className="event-date">
                        <div className="mb-1 text-primary">February, 2020</div>
                  ...
                  <SwiperSlide className="item event-list">
                    <div>
                      <div className="event-date">
                        <div className="mb-1 text-primary">March, 2020</div>
                  ...
                  <SwiperSlide className="item event-list">
                    <div>
                      <div className="event-date">
                        <div className="mb-1 text-primary">April, 2020</div>
                  ...
                  <SwiperSlide className="item event-list">
                    <div>
                      <div className="event-date">
                        <div className="mb-1 text-primary">May, 2020</div>
