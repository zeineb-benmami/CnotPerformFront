          ...
          <Row>
            ...
            <Col lg="9">
              <Row className="mb-3">
                ...
                <Col lg="8" sm="6">
                  <Form className="mt-sm-0 float-sm-end d-flex align-items-center mt-4">
              ...
              <Row>
                <Col lg="12">
                  <Pagination className="pagination pagination-rounded justify-content-center mb-4 mt-3 pb-1">
